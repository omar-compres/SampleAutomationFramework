...
class TestNegativePath:
    ...
    def test_negative_time_difference(self):
        ...
        assert Factory.utils.is_text_equal(expected_values['negative_difference'], page.price_feedback_message.text)
    ...
    def test_invalid_character_on_starting_date(self):
        ...
        page.calculate_button.click()
        assert Factory.utils.is_text_equal(expected_values['incorrect_date_value'], page.price_feedback_message.text)
    ...
    def test_invalid_character_on_starting_time(self):
        ...
        page.leaving_time_input.send_keys("07:00")
        page.calculate_button.click()
        assert Factory.utils.is_text_equal(expected_values['incorrect_time_value'], page.price_feedback_message.text)
